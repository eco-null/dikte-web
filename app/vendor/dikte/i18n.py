...
TR = {
    ...
    "Record and transcribe": "Kaydet ve yaz",
    "Result": "Sonuç",
    "Participants": "Katılımcılar",
    "Question": "Soru",
    "Answer": "Cevap",
    "No transcript yet": "Henüz transkript yok",
    "Ask": "Sor",
    "Timestamps": "Zaman damgaları",
    "Cleanup": "Temizleme",
    "Busy, one job at a time": "Meşgul: aynı anda tek iş",
    "File": "Dosya",
    "Meeting minutes": "Toplantı tutanağı",
    "Wait, still working…": "Bekle, hâlâ çalışıyor…",
    "Back": "Geri",
    "On": "Açık",
    "Status": "Durum",
    "Transcription": "Transkripsiyon",
    "Assistant": "Asistan",
    "transcribe_openai_url": "OpenAI adresi",
    "transcribe_openai_key": "OpenAI anahtarı",
    "transcribe_openai_model": "OpenAI modeli",
    "transcribe_groq_url": "Groq adresi",
    "transcribe_groq_key": "Groq anahtarı",
    "transcribe_groq_model": "Groq modeli",
    "transcribe_openrouter_url": "OpenRouter adresi",
    "transcribe_openrouter_key": "OpenRouter anahtarı",
    "transcribe_openrouter_model": "OpenRouter modeli",
    "transcribe_omniroute_url": "OmniRoute adresi",
    "transcribe_omniroute_key": "OmniRoute anahtarı",
    "transcribe_omniroute_model": "OmniRoute modeli",
    "transcribe_local_model": "Yerel whisper modeli",
    "transcribe_local_threads": "Yerel iş parçacığı",
    "transcribe_local_gpu": "Yerel GPU",
    "transcribe_local_preload": "Yerel ön yükleme",
    "cleanup_openai_url": "OpenAI adresi",
    "cleanup_openai_key": "OpenAI anahtarı",
    "cleanup_openai_model": "OpenAI modeli",
    "cleanup_groq_url": "Groq adresi",
    "cleanup_groq_key": "Groq anahtarı",
    "cleanup_groq_model": "Groq modeli",
    "cleanup_openrouter_url": "OpenRouter adresi",
    "cleanup_openrouter_key": "OpenRouter anahtarı",
    "cleanup_openrouter_model": "OpenRouter modeli",
    "cleanup_omniroute_url": "OmniRoute adresi",
    "cleanup_omniroute_key": "OmniRoute anahtarı",
    "cleanup_omniroute_model": "OmniRoute modeli",
    "cleanup_local_model": "Yerel llama modeli",
    "cleanup_local_context": "Yerel bağlam",
    "cleanup_local_reasoning": "Yerel akıl yürütme",
    "cleanup_local_threads": "Yerel iş parçacığı",
    "cleanup_local_gpu": "Yerel GPU",
    "cleanup_local_preload": "Yerel ön yükleme",
    "assistant_openai_url": "OpenAI adresi",
    "assistant_openai_key": "OpenAI anahtarı",
    "assistant_openai_model": "OpenAI modeli",
    "assistant_groq_url": "Groq adresi",
    "assistant_groq_key": "Groq anahtarı",
    "assistant_groq_model": "Groq modeli",
    "assistant_openrouter_url": "OpenRouter adresi",
    "assistant_openrouter_key": "OpenRouter anahtarı",
    "assistant_openrouter_model": "OpenRouter modeli",
    "assistant_omniroute_url": "OmniRoute adresi",
    "assistant_omniroute_key": "OmniRoute anahtarı",
    "assistant_omniroute_model": "OmniRoute modeli",
    "assistant_local_model": "Yerel llama modeli",
    "assistant_local_context": "Yerel bağlam",
    "assistant_local_reasoning": "Yerel akıl yürütme",
    "assistant_local_threads": "Yerel iş parçacığı",
    "assistant_local_gpu": "Yerel GPU",
    "assistant_local_preload": "Yerel ön yükleme",
}
